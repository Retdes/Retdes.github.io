...
/* harmony import */ var _modules_filterAlter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/filterAlter */ "./src/js/modules/filterAlter.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_filterAlter__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _services_sources__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/sources */ "./src/js/services/sources.js");
...
var filterAlter = function filterAlter() {
  ...
  var typeFilter = function typeFilter(markType) {
    ...
    wrapper.children.forEach(function (mark) {
      if (mark.classList.contains(markType)) {
        mark.style.display = 'block';
        mark.classList.add('animated', 'fadeIn');
        return;
      } else if (markType == 'grandmother' || markType == 'granddad') {
  ...
  menu.addEventListener('click', function (e) {
    ...
    if (target && target.tagName == "LI") {
      ...
      typeFilter(e.target.classList);
      target.classList.add('active');
    }
  });
};

/* harmony default export */ __webpack_exports__["default"] = (filterAlter);
...
/* harmony import */ var _services_sources__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/sources */ "./src/js/services/sources.js");
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      calcPrice = calcForm.querySelector('.calc-price'); // rulesForInput('input[name="user_phone"]');
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      calcForm.children.forEach(function (item) {
        ...
        if (item.tagName === "DIV" && item.classList.contains('calc-price')) {
          formData.append(item.getAttribute('class'), item.textContent);
        }
      ...
      if (item.closest('.popup-design') || item.classList.contains('calc-form')) {
        api = _services_sources__WEBPACK_IMPORTED_MODULE_6__["designer"];
      } else {
        api = _services_sources__WEBPACK_IMPORTED_MODULE_6__["question"];
      }
...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    ...
    if (elem.setSelectionRange) {
      elem.setSelectionRange(pos + 1, pos);
  ...
  function createMask(event) {
    ...
    if (val.charAt(0) == 7) {
      ...
      this.value = "+7 ".concat(val.slice(2, 18));
      this.blur();
    }
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _services_sources__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/sources */ "./src/js/services/sources.js");
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_4__["getResource"])(_services_sources__WEBPACK_IMPORTED_MODULE_3__["more"]).then(function (res) {
...
/***/ "./src/js/services/sources.js":
/*!************************************!*\
  !*** ./src/js/services/sources.js ***!
  \************************************/
/*! exports provided: calcUrl, more, designer, question */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calcUrl", function() { return calcUrl; });
